...
def DocxFormat(input_path, output_path, extra_fields=None):
...
if __name__ == "__main__":
    ...
    extra_fields = sys.argv[3:] if len(sys.argv) > 3 else None
    DocxFormat(input_path, output_path, extra_fields)
